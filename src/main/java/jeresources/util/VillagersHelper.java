...
public class VillagersHelper {
    public static void initRegistry(jeresources.registry.VillagerRegistry reg) {
        ...
        Registry<TradeSet> tradeSetRegistry = level.registryAccess().lookupOrThrow(Registries.TRADE_SET);
        Registry<VillagerTrade> tradeRegistry = level.registryAccess().lookupOrThrow(Registries.VILLAGER_TRADE);
