...
public class DummyWorld extends ServerLevel {
    ...
    public DummyWorld(ServerLevel level) {
        // TODO: implement
        // MinecraftServer, Executor, LevelStorageSource.LevelStorageAccess, ServerLevelData, ResourceKey<Level>, LevelStem, boolean, long, List<CustomSpawner>, boolean, RandomSequences
        super(null, null, null, null, null, null, false, 0, null, false);
